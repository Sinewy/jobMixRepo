...
if(isset($_POST["printSticker"]) && isset($_POST["productId"]) && isset($_POST["collectionId"]) && isset($_POST["formulaId"])) {
    ...
    $colorName = findColorNameByFormulaId($formulaId)["name"];
...
//    $pdf->writeHTMLCell(20, 0, 12, 46,  $html, 0, 1, 0, true, '', true);
    ...
    $pdf->SetFont('helvetica', '', 8);
    $html = "<table><tr><td>bla bla</td></tr></table>";
    $pdf->writeHTMLCell(90, 0, 21, 28,  $html, 0, 0, 0, true, '', true);


//    $pdf->SetFont('helvetica', '', 9);
//    //TODO - just a hack - make it code independant.. check locale info and based on that print correct time.
//    $date = date("d.m.Y, ");
//    $hour = date("H") + 2;
//    $date .= $hour . date(":i");
//    $html = '<span><b>Opozorilo: obvezen 2x nanos barve!</b><br>Datum proizvodnje: ' . $date . '</span>';
...
//    $pdf->Output("../files/testSticker2.pdf", 'I');
}